...
#endif
	_delay_ms(1);
	LCD_invidSendCommend(0x0C);  //Display on Cursor off
	_delay_ms(1);
	LCD_invidSendCommend(0x01);   // Clear Disp.
	_delay_ms(2);
	LCD_invidSendCommend(0x06);   //Shift cursor to the right
	return 0;
